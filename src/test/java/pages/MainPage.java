...
public class MainPage extends BasePage{
     ...
     */
    public static <T extends BasePage> T openTopMenu(WebDriver driver, String topMenuItem){ //  <T extends BasePage>: Это обобщённый тип данных. Он объявляет тип T,который является подтипом класса BasePage.
